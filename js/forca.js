...
let botaoDesapareceNovoJogo = (document.getElementById(
  "btn-novo-jogo"
).style.display = "none");
let btnSairDesaparecer = (document.getElementById("btn-sair").style.display =
  "none");
let divAgregarPalavra = (document.getElementById(
  "adicionar-palavra"
).style.display = "none");
...
var palavras = ["SOL", "LUA", "ESTRELA", "TERRA", "VENTO", "MAR"];
